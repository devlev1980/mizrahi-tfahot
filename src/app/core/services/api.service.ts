...
export class ApiService {
  private dogs: BehaviorSubject<Dog | null> = new BehaviorSubject<Dog| null>(null)
  ...
  getImgByDogKind(dogKind: string){
    return this.http.get(`${environment.serverUrl}/breed/${dogKind}/images`).pipe(
